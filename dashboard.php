        ...
        <div class="col-md-6 mb-4">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title mt-3">Gestión de Pedidos</h3>
                    <p class="card-text">Visualiza y administra los pedidos</p>
                    <a href="admin/pedidos.php" class="btn btn-warning btn-lg">
                        <i class="bi bi-arrow-right-circle"></i> Acceder
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card dashboard-card h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-title mt-3">Configuración</h3>
                    <p class="card-text">Ajustes generales del sistema</p>
                    <a href="admin/configuracion.php" class="btn btn-secondary btn-lg">
                        <i class="bi bi-arrow-right-circle"></i> Acceder
                    </a>
                </div>
            </div>
